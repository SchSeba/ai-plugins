...
Uses the Kubernetes project knowledge in [`projects/kubernetes/`](projects/kubernetes/) for the complete reference of all `hack/verify-*.sh` and `hack/update-*.sh` scripts, coding conventions, and review patterns.
