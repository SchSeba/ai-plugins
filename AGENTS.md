...
├── projects/              # Per-project learned knowledge (auto-generated by skills)
│   └── <project-name>/    #   One directory per target project (matches repo name)
│       ├── CODING.md      #     Coding best practices
│       ├── VALIDATION.md  #     Build/test/lint commands
│       └── REVIEWING.md   #     Review patterns and insights
